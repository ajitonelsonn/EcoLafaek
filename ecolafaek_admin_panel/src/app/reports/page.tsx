          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600">
                Manage waste reports and their analysis status
              </p>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="report_date_desc">
                          Latest First
                        </SelectItem>
                        <SelectItem value="report_date_asc">
                          Oldest First
                        </SelectItem>
                        <SelectItem value="severity_score_desc">
                          High Severity
                        </SelectItem>
                        <SelectItem value="severity_score_asc">
                          Low Severity
                        </SelectItem>
